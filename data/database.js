...
const vehicleDatabase = {
  ...
  "4T1C11AK5NU123456": {
    ...
    recommendations: ["Air filter replacement recommended", "Transmission fluid service due soon"],
    warranties: [
      {
        type: "Basic",
        expires: "2025-08-20",
  ...
  tools: [
    {
      ...
      description:
        "Professional diagnostic scanner with live data streaming and code clearing capabilities",
      price: 299,
      discountPrice: 249,
      discount: 17,
      category: "tools",
